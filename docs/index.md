...
# Смирнов Вячеслав<br>Рогожников Максим
...
## __Развиваю [@qa_load](https://t.me/qa_load)__
...
**_![ opacity:100% ](themes/img/tks.png)_**
...
<!-- _class: head_tks
-->
# Gatling + свои плагины *(Scala)*, k6 *(JS)*
...
Используем генераторы коллег из ФТ и АТ
...
<!-- _class: head_tks
-->
# Виды НТ по уровням зрелости команд

## __Debug/Smoke и MaxPerf с подтверждением__
## __*1.* Тесты без интеграции, бенчмарки:__
MaxPerf с подтверждением

## __*2.* Тесты с интеграцией:__
 MaxPerf с подтверждением
## __*3.* Объёмное, повторение дефектов продуктива__
## __*4.* Chaos Testing, стресс тестирование__
...
## __Генераторы под каждый вид НТ__
Настроенные для НТ
...
1. _InfluxDB для метрик Gatling и k6_
...
<!-- _class: head_tks
-->
# Не пишем отчеты, используем «Cosmos»
...
# Вопросы/ответы<br> Нагружаем банки

## __Вячеслав, Максим, [@qa_load](https://t.me/qa_load)__
